...
WebUI.setText(findTestObject('Admin/Page_OrangeHRM/input_Username_oxd-input oxd-input--focus'), 'swaq')
...
WebUI.verifyTextPresent('Should be at least 5 characters', false)
