...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Username_username'), 'Asdfh')
...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_OrangeHRM/input_Password_password'), 'sD+9iWcAW0LejHkpQKoJag==')
