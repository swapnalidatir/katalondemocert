...
WebUI.verifyElementText(findTestObject('Object Repository/Page_OrangeHRM/p_Buzz Newsfeed'), 'Buzz Newsfeed')

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/button_Most Recent Posts'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/button_Most Liked Posts'))
